      ...
      <div className='flex flex-col min-h-[150px] h-full'>
        ...
        >
          <input
            ...
            placeholder='Une question sur votre budget...?'
            className='flex-1 p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary text-slate-900 text-sm'
            disabled={isLoading}
          />
